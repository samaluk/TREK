...
import type { Trip, Day, Place, PackingItem, TodoItem, BudgetItem, BudgetCategoryBudget, BudgetTransaction, Reservation, TripFile, Accommodation, TripMember } from '../types'
...
async function syncTrip(tripId: number): Promise<void> {
  ...
  await upsertBudgetTransactions(bundle.budgetTransactions || [])
  await upsertBudgetCategoryBudgets(bundle.budgetCategoryBudgets || [])
